...
class Sz_Vendor_Block_Adminhtml_Partners_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareColumns(){
        ...
        $this->addColumn('action',
            array(
                'header'    => Mage::helper('vendor')->__('CSV File Lists URL'),
                'width'     => '80px',
                'type'      => 'action',
                'getter'     => 'getId',
                'actions'   => array(
                    array(
                        'caption' => Mage::helper('vendor')->__('File List URL'),
                        'url'     => array(
                            'base'=>'*/adminhtml_products/processcsv'
                        ),
                        'field'   => 'id'
                    )
                ),
        ...
        $this->addColumn('product_list',
            array(
                'header'    => Mage::helper('vendor')->__('List Of Unapproved Products'),
                'width'     => '80px',
                'type'      => 'action',
                'getter'     => 'getId',
                'actions'   => array(
                    array(
                        'caption' => Mage::helper('vendor')->__('Product List URL'),
                        'url'     => array(
                            'base'=>'*/adminhtml_products/index'
                        ),
                        'field'   => 'vendor_id'
                    )
                ),
