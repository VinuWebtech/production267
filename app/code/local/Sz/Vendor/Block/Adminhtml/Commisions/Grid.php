<?php
class Sz_Vendor_Block_Adminhtml_Commisions_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
   ...
   protected function _prepareCollection()     {
       // $global_comm_percent = 20;
        ...
        $collection->getSelect()->join(array("cpu" => $prefix."vendor_userdata"),"cpu.mageuserid = main_table.mageuserid",array("partnerstatus"=>"partnerstatus","paymentsource"=>"paymentsource"));
        ...
        foreach ($collection as $data) {            
            ...
            $data->order=sprintf('<a href="%s" title="View Order">View Order</a>',
                                             $this->getUrl('vendor/adminhtml_order/index/id/'.$data->getMageuserid().'/')
                                            );
        }             
    }
