 ...
 */
class Sz_Sales_Model_Service_Quote extends Mage_Sales_Model_Service_Quote
{
    /**
    ...
    protected function _validate()
    {
        if (!$this->getQuote()->isVirtual()) {
            ...
            //removed the shipping method validation
            //in order to place order without shipping method
        }
