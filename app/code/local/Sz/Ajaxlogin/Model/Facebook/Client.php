...
class Sz_Ajaxlogin_Model_Facebook_Client
{
    const REDIRECT_URI_ROUTE = 'ajaxlogin/facebook/connect';

    const XML_PATH_ENABLED = 'ajaxlogin_options/ajaxlogin_facebook/enabled';
    const XML_PATH_CLIENT_ID = 'ajaxlogin_options/ajaxlogin_facebook/client_id';
    const XML_PATH_CLIENT_SECRET = 'ajaxlogin_options/ajaxlogin_facebook/client_secret';
