<?php
class Sz_Ajaxlogin_Model_Google_Client
{
    const REDIRECT_URI_ROUTE = 'ajaxlogin/google/connect';

    const XML_PATH_ENABLED = 'ajaxlogin_options/ajaxlogin_google/enabled';
    const XML_PATH_CLIENT_ID = 'ajaxlogin_options/ajaxlogin_google/client_id';
    const XML_PATH_CLIENT_SECRET = 'ajaxlogin_options/ajaxlogin_google/client_secret';
    ...
    public function __construct($params = array())
    {
        if(($this->isEnabled = $this->_isEnabled())) {
            ...
            Mage::log($this->redirectUri,null,'redirectUri.log',true);
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                if(isset($decoded_response->error->message)) {
                    ...
                    $message = Mage::helper('sz_ajaxlogin')
